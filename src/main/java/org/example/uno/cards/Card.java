...
public abstract class Card {
    ...
    public boolean isCardPlaceable(UnoGame game, Card placeCard){
        ...
        boolean wildDrawTwoCardMatch = (placeCard instanceof WildDrawTwoCard);
        ...
        return deckColorMatch || wildCardMatch || reverseCardsMatch || drawOneCardMatch || skipCardMatch || wildDrawTwoCardMatch;
    }
